...
INSERT INTO orders (id, user_id, total_amount, currency, status, region_name, created_at, updated_at) VALUES
    (1, 1, 142.00, 'USD', 'completed', 'North America (East)', '2026-03-07 08:14:00+00', '2026-03-07 08:19:00+00'),
    (2, 7, 958.00, 'USD', 'pending', 'North America (West)', '2026-03-07 08:18:00+00', '2026-03-07 08:18:00+00'),
    (3, 13, 277.00, 'USD', 'completed', 'Western Europe', '2026-03-07 08:24:00+00', '2026-03-07 08:30:00+00'),
    (4, 19, 64.00, 'USD', 'failed', 'Japan', '2026-03-07 08:29:00+00', '2026-03-07 08:31:00+00'),
    (5, 24, 321.00, 'USD', 'completed', 'Southeast Asia', '2026-03-07 08:34:00+00', '2026-03-07 08:38:00+00'),
    (6, 30, 117.00, 'USD', 'completed', 'Australia', '2026-03-07 08:39:00+00', '2026-03-07 08:43:00+00'),
    (7, 35, 177.00, 'USD', 'refunded', 'Brazil', '2026-03-07 08:42:00+00', '2026-03-07 09:05:00+00'),
    (8, 40, 985.00, 'USD', 'completed', 'India', '2026-03-07 08:47:00+00', '2026-03-07 08:55:00+00'),
    (9, 46, 88.40, 'USD', 'completed', 'South Africa', '2026-03-07 08:52:00+00', '2026-03-07 08:58:00+00'),
    (10, 5, 59.90, 'USD', 'pending', 'North America (East)', '2026-03-07 08:56:00+00', '2026-03-07 08:56:00+00'),
    (11, 11, 475.00, 'USD', 'completed', 'North America (West)', '2026-03-07 09:00:00+00', '2026-03-07 09:07:00+00'),
    (12, 17, 29.99, 'USD', 'failed', 'Western Europe', '2026-03-07 09:04:00+00', '2026-03-07 09:06:00+00'),
    (13, 22, 520.00, 'USD', 'completed', 'Japan', '2026-03-07 09:08:00+00', '2026-03-07 09:12:00+00'),
    (14, 28, 73.50, 'USD', 'completed', 'Southeast Asia', '2026-03-07 09:11:00+00', '2026-03-07 09:15:00+00'),
    (15, 43, 142.00, 'USD', 'completed', 'India', '2026-03-07 09:16:00+00', '2026-03-07 09:20:00+00'),
    (16, 49, 210.00, 'USD', 'completed', 'South Africa', '2026-03-07 09:22:00+00', '2026-03-07 09:27:00+00'),
    (17, 38, 67.89, 'USD', 'completed', 'Brazil', '2026-03-07 09:28:00+00', '2026-03-07 09:31:00+00');
...
INSERT INTO user_events (id, user_id, event_type, page_url, referrer_url, user_agent, ip_address, session_id, metadata, created_at) VALUES
    (1, 1, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 14_0)', '203.0.113.1', '00000000-0000-4000-8000-000000000001', '{"auth":"password"}'::jsonb, '2026-03-07 08:00:05+00'),
    (2, 1, 'page_view', '/products/4', '/home', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 14_0)', '203.0.113.1', '00000000-0000-4000-8000-000000000001', '{"product_id":4}'::jsonb, '2026-03-07 08:04:00+00'),
    (3, 1, 'add_to_cart', '/cart', '/products/4', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 14_0)', '203.0.113.1', '00000000-0000-4000-8000-000000000001', '{"product_id":4,"quantity":1}'::jsonb, '2026-03-07 08:11:00+00'),
    (4, 1, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 14_0)', '203.0.113.1', '00000000-0000-4000-8000-000000000001', '{"order_id":1}'::jsonb, '2026-03-07 08:19:00+00'),
    (5, 2, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.2', '00000000-0000-4000-8000-000000000002', '{"auth":"password"}'::jsonb, '2026-03-07 08:10:15+00'),
    (6, 2, 'search', '/search', '/home', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.2', '00000000-0000-4000-8000-000000000002', '{"query":"smartwatch"}'::jsonb, '2026-03-07 08:16:00+00'),
    (7, 5, 'page_view', '/products/12', '/home', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.5', '00000000-0000-4000-8000-000000000003', '{"product_id":12}'::jsonb, '2026-03-07 08:21:00+00'),
    (8, 5, 'add_to_cart', '/cart', '/products/12', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.5', '00000000-0000-4000-8000-000000000003', '{"product_id":12,"quantity":1}'::jsonb, '2026-03-07 08:23:00+00'),
    (9, 7, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.7', '00000000-0000-4000-8000-000000000004', '{"auth":"google"}'::jsonb, '2026-03-07 07:50:20+00'),
    (10, 7, 'page_view', '/products/2', '/home', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.7', '00000000-0000-4000-8000-000000000004', '{"product_id":2}'::jsonb, '2026-03-07 08:12:00+00'),
    (11, 7, 'checkout_start', '/checkout', '/cart', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.7', '00000000-0000-4000-8000-000000000004', '{"cart_value":958.0}'::jsonb, '2026-03-07 08:18:15+00'),
    (12, 8, 'page_view', '/products/12', '/campaign/spring', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.8', '00000000-0000-4000-8000-000000000005', '{"product_id":12}'::jsonb, '2026-03-07 08:32:00+00'),
    (13, 11, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (X11; Linux x86_64)', '203.0.113.11', '00000000-0000-4000-8000-000000000006', '{"order_id":11}'::jsonb, '2026-03-07 09:07:00+00'),
    (14, 13, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.13', '00000000-0000-4000-8000-000000000007', '{"auth":"password"}'::jsonb, '2026-03-07 08:00:30+00'),
    (15, 13, 'page_view', '/collections/spring', '/home', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.13', '00000000-0000-4000-8000-000000000007', '{"collection":"spring"}'::jsonb, '2026-03-07 08:10:00+00'),
    (16, 13, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '203.0.113.13', '00000000-0000-4000-8000-000000000007', '{"order_id":3}'::jsonb, '2026-03-07 08:30:00+00'),
    (17, 15, 'search', '/search', '/home', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.15', '00000000-0000-4000-8000-000000000008', '{"query":"performance jacket"}'::jsonb, '2026-03-07 08:35:00+00'),
    (18, 18, 'logout', '/logout', '/account', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.18', '00000000-0000-4000-8000-000000000009', '{"reason":"manual"}'::jsonb, '2026-03-07 09:02:00+00'),
    (19, 19, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.19', '00000000-0000-4000-8000-000000000010', '{"auth":"password"}'::jsonb, '2026-03-07 08:05:10+00'),
    (20, 19, 'error', '/checkout', '/cart', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.19', '00000000-0000-4000-8000-000000000010', '{"code":"PAYMENT_TIMEOUT","severity":"warning"}'::jsonb, '2026-03-07 08:31:00+00'),
    (21, 20, 'page_view', '/products/13', '/home', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.20', '00000000-0000-4000-8000-000000000011', '{"product_id":13}'::jsonb, '2026-03-07 08:56:00+00'),
    (22, 22, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.22', NULL, '{"order_id":13}'::jsonb, '2026-03-07 09:12:00+00'),
    (23, 24, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.24', '00000000-0000-4000-8000-000000000012', '{"auth":"otp"}'::jsonb, '2026-03-07 08:12:10+00'),
    (24, 24, 'add_to_cart', '/cart', '/products/7', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.24', '00000000-0000-4000-8000-000000000012', '{"product_id":7,"quantity":1}'::jsonb, '2026-03-07 08:32:00+00'),
    (25, 24, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.24', '00000000-0000-4000-8000-000000000012', '{"order_id":5}'::jsonb, '2026-03-07 08:38:00+00'),
    (26, 26, 'click', '/promo/summer', '/home', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.26', '00000000-0000-4000-8000-000000000013', '{"campaign":"summer-promo"}'::jsonb, '2026-03-07 08:49:00+00'),
    (27, 28, 'page_view', '/products/8', '/home', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.28', '00000000-0000-4000-8000-000000000014', '{"product_id":8}'::jsonb, '2026-03-07 09:02:00+00'),
    (28, 28, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.28', '00000000-0000-4000-8000-000000000014', '{"order_id":14}'::jsonb, '2026-03-07 09:15:00+00'),
    (29, 30, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.30', '00000000-0000-4000-8000-000000000015', '{"auth":"password"}'::jsonb, '2026-03-07 07:40:20+00'),
    (30, 30, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.30', '00000000-0000-4000-8000-000000000015', '{"order_id":6}'::jsonb, '2026-03-07 08:43:00+00'),
    (31, 35, 'add_to_cart', '/cart', '/products/18', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.35', '00000000-0000-4000-8000-000000000017', '{"product_id":18,"quantity":1}'::jsonb, '2026-03-07 08:40:30+00'),
    (32, 35, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.35', '00000000-0000-4000-8000-000000000017', '{"order_id":7}'::jsonb, '2026-03-07 08:44:00+00'),
    (33, 38, 'page_view', '/products/24', '/home', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.38', '00000000-0000-4000-8000-000000000018', '{"product_id":24}'::jsonb, '2026-03-07 09:03:00+00'),
    (34, 38, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.38', '00000000-0000-4000-8000-000000000018', '{"order_id":17}'::jsonb, '2026-03-07 09:31:00+00'),
    (35, 40, 'login', '/login', 'https://nexus.test/', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.40', '00000000-0000-4000-8000-000000000019', '{"auth":"password"}'::jsonb, '2026-03-07 08:18:10+00'),
    (36, 40, 'search', '/search', '/home', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.40', '00000000-0000-4000-8000-000000000019', '{"query":"4k monitor"}'::jsonb, '2026-03-07 08:40:00+00'),
    (37, 40, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.40', '00000000-0000-4000-8000-000000000019', '{"order_id":8}'::jsonb, '2026-03-07 08:55:00+00'),
    (38, 43, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X)', '203.0.113.43', '00000000-0000-4000-8000-000000000021', '{"order_id":15}'::jsonb, '2026-03-07 09:20:00+00'),
    (39, 46, 'page_view', '/products/15', '/home', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.46', '00000000-0000-4000-8000-000000000022', '{"product_id":15}'::jsonb, '2026-03-07 08:15:00+00'),
    (40, 49, 'checkout_complete', '/checkout/confirmation', '/checkout', 'Mozilla/5.0 (Linux; Android 15)', '203.0.113.49', '00000000-0000-4000-8000-000000000024', '{"order_id":16}'::jsonb, '2026-03-07 09:27:00+00');
